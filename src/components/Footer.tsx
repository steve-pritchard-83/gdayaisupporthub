      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p className="footer-description">
              G'day AI Support Hub - Your gateway to better AI experiences. 
              Submit tickets, browse our knowledge base, and get the help you need.
            </p>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="https://gdaygroup.com.au" target="_blank" rel="noopener noreferrer">
                  <Globe size={14} />
                  G'day Group Website
                </a>
              </li>
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; 2025 G'day Group. All rights reserved.</p>
          </div>
          <div className="footer-version">
            <p>Support Hub v1.0</p>
          </div>
        </div>
      </div>
    </footer>
