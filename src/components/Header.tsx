    ...
    <header className="header" ref={headerRef}>
      <div className="container">
        <div className="header-content">
          <Link to="/" className="logo">
            ...
            >
              <g fill="none" fillRule="evenodd">
                <path 
                  d="m117.575713 43.6086957c-21.7372402 0-42.0363887-10.5778831-54.3003507-28.2962333l22.7693827-15.3124624c7.1251362 10.2937071 18.912356 16.4393901 31.530968 16.4393901 12.615875 0 24.401727-6.1436604 31.527206-16.43365939l22.766646 15.31650769c-12.264646 17.7119452-32.5614 28.2864573-54.293852 28.2864573" 
                  fill="#fd0"
                />
                <g fill="#fdfdfd">
          ...
          <h1 className="header-title">G'day AI Support Hub</h1>
          ...
          <nav className="nav">
            ...
            >
              Admin Panel
              {state.tickets.filter(t => t.status === 'pending').length > 0 && (
