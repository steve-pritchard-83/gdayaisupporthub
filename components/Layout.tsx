...
import { Menu, X, Home, Plus, List, BookOpen, Shield, Sun, Moon } from 'lucide-react';
...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-primary-bg">
      {/* Header */}
      <header className="bg-surface shadow-xl border-b border-color">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <button
                onClick={toggleTheme}
                className="p-2 rounded-lg text-secondary hover:text-primary hover:bg-surface-light transition-colors"
            ...
            <div className="md:hidden flex items-center space-x-2">
              ...
              {/* Mobile menu button */}
              <button
                className="p-2 rounded-lg text-secondary hover:text-primary hover:bg-surface-light focus-ring"
      ...
      <footer className="bg-surface border-t border-color mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="text-center text-sm text-muted">
            © 2025 G'day AI Support Hub. Built for managing AI tool access requests.
          </div>
        </div>
      </footer>
    </div>
